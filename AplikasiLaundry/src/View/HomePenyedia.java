...
import Controller.PenyediaHome;
...
public class HomePenyedia extends javax.swing.JFrame {
    public static DefaultTableModel modeltab1, modeltab2, modeltab3;
    int xx,xy;
    private PenyediaHome PenyediaHome;
    ...
    public HomePenyedia() {
        ...
        PenyediaHome = new PenyediaHome(this);
    }
    ...
    private void initComponents() {
        ...
        button7.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        button7.setForeground(new java.awt.Color(255, 255, 255));
        button7.setLabel("Tambahkan");
        button7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button7ActionPerformed(evt);
            }
        });
        show_2.add(button7, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 460, 110, 50));

        jLabel36.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel36.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel36.setText("Jenis Barang Yang diLaundry");
        show_2.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 80, 460, 30));
        ...
        show_2.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 120, -1, -1));

        jLabel4.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Laundrymu");
        ...
        jTable3.setFont(new java.awt.Font("Century", 0, 12)); // NOI18N
        ...
        show_2.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 140, 470, 190));
        ...
        show_2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 460, 410));
        ...
        show_2.add(button4, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 340, 110, 50));

        jLabel40.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel40.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel40.setText("Harga");
        show_2.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 430, 90, -1));

        jLabel39.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel39.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel39.setText("Harga per");
        show_2.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 400, 90, -1));

        jLabel38.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel38.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel38.setText("Nama Barang");
        show_2.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, 90, -1));
        ...
        show_2.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));

        jLabel31.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(102, 102, 102));
        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel31.setText("Total Pemasukan: Rp.[Pemasukan]");
        show_2.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 490, 460, -1));

        jLabel37.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel37.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel37.setText("Form Jenis Laundry-an");
        show_2.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 340, 350, -1));
        show_2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 370, 240, -1));
        show_2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 430, 240, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "KiloGram", "Item" }));
        show_2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 400, 240, -1));
        ...
        button5.setActionCommand("Detail Penyedia");
        ...
        button5.setLabel("Masukkan Pembayaran");
        button5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button5ActionPerformed(evt);
            }
        });
        show_3.add(button5, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 450, 180, 50));
        ...
        button2.setLabel("Detail Pengguna");
        button2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button2ActionPerformed(evt);
            }
        });
        show_3.add(button2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 450, 140, 50));
        ...
        show_3.add(button6, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 450, 260, 50));
        ...
        show_5.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 230, -1));
                ...
                for(;;){
                    try{
                        ...
                        if(jTable2.getSelectedRow() > -1){
                            if(jTable2.getValueAt(jTable2.getSelectedRow(), 2).toString().equals("0")){
                                button2.setVisible(true);
                                button6.setVisible(true);
                                button6.setLabel("Telah Menjemput? Klik Disini");
                                
                                button5.setVisible(false);
                            }else if(jTable2.getValueAt(jTable2.getSelectedRow(), 2).toString().equals("1")){
                                button5.setVisible(true);
                                button2.setVisible(true);
                                button6.setVisible(true);
                                button6.setLabel("Telah Dicuci? Klik Disini");
                            }else if(jTable2.getValueAt(jTable2.getSelectedRow(), 2).toString().equals("2")){
                                button5.setVisible(true);
                                button2.setVisible(true);
                        ...
                        Logger.getLogger(View.HomePenyedia.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }   
        };
    ...
    private void jLabel33MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel33MouseClicked
        PenyediaHome.setTabelDeskripsi();
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        PenyediaHome.getDataUserViaJOptionPane(jTable2.getValueAt(jTable2.getSelectedRow(), 1).toString());
    }//GEN-LAST:event_button2ActionPerformed

    private void jLabel34MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel34MouseClicked
        PenyediaHome.setTabelLaporanPembayaran();
    }//GEN-LAST:event_jLabel34MouseClicked

    private void button6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button6ActionPerformed
        if(jTable2.getValueAt(jTable2.getSelectedRow(), 2).toString().equals("0")){
            PenyediaHome.updateStatusLaundry(jTable2.getValueAt(jTable2.getSelectedRow(), 0).toString(), "1");
        }else if(jTable2.getValueAt(jTable2.getSelectedRow(), 2).toString().equals("1")){
            PenyediaHome.updateStatusLaundry(jTable2.getValueAt(jTable2.getSelectedRow(), 0).toString(), "2");
        }
        PenyediaHome.setTabelDeskripsi();
    }//GEN-LAST:event_button6ActionPerformed

    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        PenyediaHome.openEditProfile();
    }//GEN-LAST:event_button3ActionPerformed

    private void jLabel35MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel35MouseClicked
        PenyediaHome.setTabelJenisLaundry();
    }//GEN-LAST:event_jLabel35MouseClicked

    private void button5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button5ActionPerformed
        PenyediaHome.openLaporanUser(jTable2.getValueAt(jTable2.getSelectedRow(), 0).toString());
    }//GEN-LAST:event_button5ActionPerformed

    private void button4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button4ActionPerformed
        PenyediaHome.deleteDataJenisLaundry(jTable3.getValueAt(jTable3.getSelectedRow(), 0).toString());
        PenyediaHome.setTabelJenisLaundry();
    }//GEN-LAST:event_button4ActionPerformed

    private void button7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button7ActionPerformed
        PenyediaHome.addDataJenisLaundry();
        PenyediaHome.setTabelJenisLaundry();
    ...
    public JLabel setTotal(){
        return jLabel31;
    }
    
    //Tabel
    public JTable tabelLaporanPembayaran(){
        return jTable1;
    }
    public JTable tabelJenisLaundry(){
        return jTable3;
    }
    ...
    //Form Jenis Laundry
    public JTextField nameBarang(){
        return jTextField1;
    }
    public JComboBox nameHargaPer(){
        return jComboBox1;
    }
    public JTextField nameHarga(){
        return jTextField2;
    }
    /**
